...
- **Evidence:** open as of 2026-08-12, with the exclusion boundary implemented and the item's
  ...
  **Five of the six rows closed 2026-08-22 at `a8be93f`**, verified by the complete pipeline against
  committed content at that exact commit — tree `848dfdc`, six gate stages passed, `validate` advisory
  as it is on `develop`. Twelve tests across two files, kept apart deliberately: a tree excluded from
